...
if(isset($_POST['delete_video'])){
   ...
   if($verify_video->rowCount() > 0){
      ...
      $message[] = 'Video sudah dihapus sebelumnya!';
   }
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Perbarui playlist</a>
            <input type="submit" value="Hapus playlist" class="delete-btn" onclick="return confirm('Hapus playlist ini?');" name="delete_playlist">
         </form>
      </div>
   </div>
   <?php
