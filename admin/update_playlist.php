...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="Perbarui Playlist" name="submit" class="btn">
      <div class="flex-btn">
         <input type="submit" value="Hapus" class="delete-btn" onclick="return confirm('Hapus playlist ini?');" name="delete">
