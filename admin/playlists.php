...
<section class="playlists">
   ...
   <h1 class="heading">Daftar Putar yang Ditambahkan</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Buat Daftar Putar Baru</h3>
         <a href="add_playlist.php" class="btn">Tambahkan Daftar Putar</a>
      </div>
      ...
      <?php
            ...
            echo '<p class="empty">Belum ada daftar putar ditambahkan!</p>';
         }
      ?>
