...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="Silakan masukkan komentar Anda" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">Batal Edit</a>
         <input type="submit" value="Perbarui Sekarang" name="update_now" class="inline-btn">
      </div>
   </form>
</section>
<?php
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>Suka</span></button>
         <?php
         }else{
         ?>
...
<!-- Bagian Tonton Video berakhir -->

<!-- Bagian Komentar dimulai  -->
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="Tulis komentar Anda di sini..." maxlength="1000" cols="30" rows="10"></textarea>
